...
class __TwigTemplate_9c25f8adb5aac37e08af9100809b34c7 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {% if link is not defined or link %}<a href=\"{{ url('webprofiler.dashboard', { token: token, panel: name }) }}\">{% endif %}
        <div class=\"sf-toolbar-icon\">{{ icon|default('') }}</div>
    {% if link|default(false) %}</a>{% endif %}
        <div class=\"sf-toolbar-info\">{{ text|default('') }}</div>
</div>
", "@webprofiler/Profiler/toolbar_item.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/plantilla_ws/web/modules/contrib/webprofiler/templates/Profiler/toolbar_item.html.twig");
    }
