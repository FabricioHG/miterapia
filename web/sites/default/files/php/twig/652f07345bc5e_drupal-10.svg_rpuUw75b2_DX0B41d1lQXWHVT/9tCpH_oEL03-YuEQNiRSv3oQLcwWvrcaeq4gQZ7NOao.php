...
class __TwigTemplate_cee2640bcbc1851e2d537049f07d891d extends Template
{
    private $source;
    private $macros = [];
...
\t\tc-0.1-0.1-0.1-0.2-0.1-0.3l0,0V9.3c0-0.2,0-0.3,0.1-0.5c0-0.1,0.1-0.2,0.2-0.3C11.4,8.2,11.7,7.9,12,7.6z\"/>
    ...
    {
        return new Source("<svg xmlns=\"http://www.w3.org/2000/svg\" x=\"0px\" y=\"0px\"
\t viewBox=\"0 0 24 24\" style=\"enable-background:new 0 0 24 24;\" xml:space=\"preserve\">
<style type=\"text/css\">
\t.st0{fill:#AAAAAA;}
</style>
...
</svg>", "@webprofiler/Icon/drupal-10.svg", "/Applications/XAMPP/xamppfiles/htdocs/plantilla_ws/web/modules/contrib/webprofiler/templates/Icon/drupal-10.svg");
    }
